...
| [Repl.it](https://replit.com) | 支持多语言的云端IDE | `多语言` `云端` `协作` |
...
| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [Postman](https://www.postman.com) | API开发和测试平台 | `API测试` `团队协作` `文档生成` |
...
| [MDN](https://developer.mozilla.org) | Web开发权威文档 | `文档` `标准` `教程` |
...
| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [freeCodeCamp](https://www.freecodecamp.org) | 免费的编程学习平台 | `免费` `全栈` `认证` |
| [LeetCode](https://leetcode.com) | 算法和数据结构练习 | `算法` `面试` `竞赛` |
| [Coursera](https://www.coursera.org) | 在线课程平台 | `大学课程` `认证` `专业课程` |
| [慕课网](https://www.imooc.com) | IT技能学习平台 | `中文` `实战` `体系化` |
...
| [Behance](https://www.behance.net) | Adobe的创意作品平台 | `创意作品` `专业` `多媒体` |

### 语言学习

| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [Duolingo](https://www.duolingo.com) | 游戏化语言学习 | `游戏化` `多语言` `免费` |
| [HelloTalk](https://www.hellotalk.com) | 语言交换社交平台 | `语言交换` `社交` `实践` |
...
| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [Iconfont](https://www.iconfont.cn) | 阿里巴巴图标库 | `中文` `免费` `矢量` |
...
| [中国传统颜色](http://zhongguose.com) | 中国传统色彩 | `传统` `文化` `美学` |
...
| [字由](https://www.hellofont.cn) | 字体管理和使用工具 | `字体管理` `商用授权` `中文` |
...
| [PDF24](https://www.pdf24.org) | PDF在线处理工具 | `PDF处理` `多功能` `免费` |
...
| [Online-Convert](https://www.online-convert.com) | 在线文件转换 | `文件转换` `多类型` `免费` |

### 生产力工具

| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [Notion](https://www.notion.so) | 全能笔记和协作工具 | `笔记` `协作` `数据库` |
| [语雀](https://www.yuque.com) | 阿里巴巴知识管理平台 | `知识管理` `中文` `团队协作` |
| [石墨文档](https://shimo.im) | 在线协作文档 | `协作文档` `实时编辑` `中文` |
...
| [Pexels](https://www.pexels.com) | 免费图片和视频 | `免费素材` `图片视频` `CC0` |
...
| [Chart.js](https://www.chartjs.org) | 简单灵活的图表库 | `图表库` `JavaScript` `响应式` |
...
| 网站 | 描述 | 特色标签 |
|------|------|----------|
| [SpeedTest](https://www.speedtest.net) | 网络速度测试 | `网速测试` `全球节点` `详细报告` |
